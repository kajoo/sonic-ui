...
import WarpComponent from '../../../BaseComponents/WarpComponent';
...
const target = {
  ...
  canDrop({ id, index, containerId, groupName, item, canDrop, droppable }) {
...
class DraggableTarget extends WarpComponent {
  registerNode = node => {
