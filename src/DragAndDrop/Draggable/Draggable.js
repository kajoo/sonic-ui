...
export class Draggable extends React.Component {
  ...
  // canDrop = ({ id, index, containerId, groupName, item }) => {
  //   const canDragByDelay = this.props.delay ? !this.state.delayed : true;
  //   const propsCanDrag = this.props.canDrop
  //     ? this.props.canDrop({
  //         id,
  //         index,
  //         containerId,
  ...
  render() {
    const { hasDragged, canDrop, ...restProps } = this.props;
...
Draggable.propTypes = {
  ...
  /** callback that could prevent item from dropping */
